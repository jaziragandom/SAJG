...
export default function Hero() {
  ...
  // دیتای شبیه‌سازی شده که دقیقا ساختار خروجی پنل ادمین را دارد
  ...
  // افزودن current به وابستگی‌ها تا با کلیک روی نقطه‌ها، تایمر ریست شود و پرش ناگهانی نداشته باشیم
  useEffect(() => {
    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* لایه قطعات معلق (Floaters) - بدون ماسک */}
          ...
          {/* کانتینر تصاویر محصول و انعکاس - ماسک فقط روی این بخش اعمال شد */}
          <div 
          ...
          <div className="w-full md:w-[45%] h-[50%] md:h-full flex flex-col justify-center items-start text-right z-30 pt-32 mt-12 md:pt-0 md:mt-0 relative">
            ...
            >
              <Link href={productLink} className="pointer-events-auto block">
      ...
      {/* هاله رنگی بک‌گراند - ماسک فقط روی این بخش هم اعمال شد */}
      <div 
      ...
      {/* نقطه‌های ناوبری قابل کلیک - خارج از لایه ماسک */}
